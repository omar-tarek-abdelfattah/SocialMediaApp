...
router.post('/', (0, authentication_middleware_1.authentication)(), (0, multer_cloud_1.cloudFileUpload)({ validation: multer_cloud_1.fileValidation.image }).array("attachments", 2), (0, validation_middleware_1.validation)(validators.createPost), post_service_1.default.createPost);
